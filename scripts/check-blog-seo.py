...
CHAMPS = {
    ...
    "serrurier-rennes-nouvel-arrivant.html": {
        ...
        "termes": [
            ...
            ["cotes", "dimensions"],
            ["A2P"], ["certifiée"], ["dormant"], ["pêne"],
            ["crochetage"], ["tentative d'effraction"], ["cambriolage"],
            ["multipoints"], ["cylindres"],
        ],
        # Les 36 mots-clés demandés : présence ET emploi répété.
        "renforces": [
            ["serruriers"], ["A2P"], ["haute sécurité"],
            ["cambriolage"], ["blindées"], ["portes blindées"],
            ["Fichet"], ["Vachette"], ["porte de garage"],
            ["métalliques"], ["cylindres"], ["certifiée"],
            ["cambrioleurs"], ["verrou"], ["verrouillage"],
            ["cambriolages"], ["dépannages"], ["niveau de sécurité"],
            ["verrous"], ["ouvrir la porte"], ["dépanner"],
            ["pêne"], ["fermetures"], ["entreprise serrurerie"],
            ["toutes les marques"], ["portes d'entrée"], ["dormant"],
            ["serrure multipoints"], ["dépannage serrure"], ["installateur"],
            ["porte claquée"], ["serrure de sécurité"], ["stores"],
            ["rideaux"], ["crochetage"], ["tentative d'effraction"],
        ],
    },
    "serrurier-saint-malo-intra-muros.html": {
        ...
        "termes": [
            ...
            ["A2P"], ["haute sécurité"], ["blindage"],
            ["multipoints"], ["barillet"], ["crochetage"],
            ["tentative d'effraction"], ["coffre-fort", "coffres-forts"],
        ],
        # Les 36 mots-clés demandés : présence ET emploi répété.
        "renforces": [
            ["A2P"], ["haute sécurité"], ["porte d'entrée"],
            ["blindées"], ["serruriers"], ["multipoints"],
            ["cambriolage"], ["verrouillage"], ["portes blindées"],
            ["Vachette"], ["porte de garage"], ["verrou"],
            ["Fichet"], ["barillet"], ["clefs"],
            ["serrure multipoints"], ["métalliques"], ["cambrioleurs"],
            ["ouvrir la porte"], ["installateur"], ["crochetage"],
            ["niveau de sécurité"], ["cambriolages"], ["fermetures"],
            ["coffres"], ["menuiserie"], ["verrous"],
            ["serrure porte"], ["artisan serrurier"], ["tentative d'effraction"],
            ["coffres-forts"], ["serrurier professionnel"], ["stores"],
            ["dépannage serrure"], ["portes de garage"], ["dépanner"],
        ],
    },
    ...
    "serrurier-nuit-week-end-ille-et-vilaine-35.html": {
        "requete": "serrurier nuit week-end Ille-et-Vilaine majoration",
        "termes": [
            ["Ille-et-Vilaine"], ["Rennes"], ["Saint-Malo"],
            ["Fougères"], ["Vitré"], ["Redon"], ["Dinard"],
            ["nuit"], ["week-end", "samedi"], ["vendredi"],
            ["majoration"], ["19 h", "19h"], ["dimanche"],
            ["jour férié", "jours fériés"], ["tarif de journée", "tarif"],
            ["porte claquée"], ["pêne demi-tour", "pêne"],
            ["fermée à clé", "verrouillée"], ["serrurier"], ["serrure"],
            ["devis"], ["déplacement"], ["estimation"],
            ["attendre"], ["hébergement", "hôtel"], ["calcul"],
            ["enfant"], ["secours", "pompiers"], ["112", "le 18"],
            ["plaque de cuisson", "appareil"], ["effraction"],
            ["colocation"], ["étudiant"], ["bail"],
            ["justificatif"], ["pièce d'identité", "identité"],
            ["quittance"], ["organigramme"], ["gestionnaire", "syndic"],
            ["assurance"], ["assistance"], ["obligation"],
            ["information préalable", "avant l'intervention", "avant tout déplacement"],
            ["interphone", "code d'accès", "immeuble"],
            ["accès"], ["cylindre"], ["urgence"],
        ],
    },
    "serrurier-nuit-delai-finistere-29.html": {
        "requete": "serrurier urgence Finistère délai intervention",
        "termes": [
            ["Finistère"], ["Brest"], ["Quimper"], ["Concarneau"],
            ["Morlaix"], ["Douarnenez"], ["Crozon"], ["pointe du Raz", "pointe"],
            ["délai"], ["distance"], ["route"], ["trajet"],
            ["point de départ", "d'où part"], ["commune"],
            ["promesse", "promettre"], ["vingt minutes", "20 minutes"],
            ["intermédiaire", "centre d'appel"], ["revend", "revendue", "revendre"],
            ["pièce dans le véhicule", "véhicule"], ["matériel"],
            ["rappeler"], ["estimation"], ["devis"], ["majoration"],
            ["déplacement"], ["annulé", "annulation"],
            ["Penfeld"], ["quartier"], ["Reconstruction"],
            ["bigouden", "Pont-l'Abbé"], ["littoral", "côte"],
            ["résidence secondaire", "résidences secondaires"],
            ["air marin", "sel"], ["pluie", "vent"], ["brouillard"],
            ["non destructive", "sans casse"], ["forcer"],
            ["justificatif"], ["pièce d'identité", "identité"],
            ["serrurier"], ["serrure"], ["cylindre"], ["urgence"],
            ["multipoints", "points de fermeture"], ["assistance"],
            ["SIRET", "annuaire des entreprises"],
        ],
    },
    "serrurier-urgence-saison-morbihan-56.html": {
        "requete": "serrurier urgence Morbihan saison été location",
        "termes": [
            ["Morbihan"], ["Vannes"], ["Lorient"], ["Pontivy"],
            ["Ploërmel"], ["Auray"], ["golfe"], ["Rhuys"],
            ["Quiberon"], ["Sarzeau", "Arzon"],
            ["saison", "saisonnier", "saisonnière"], ["août"], ["été"],
            ["hors saison"], ["hiver"], ["printemps"],
            ["tourisme", "touristique"], ["location", "locations"],
            ["meublé", "meublés"], ["résidence secondaire", "résidences secondaires"],
            ["clé non restituée", "clé non rendue", "non restituée"],
            ["boîte à clés"], ["jeu", "jeux"], ["registre"],
            ["cylindre"], ["grippé", "grippe"], ["air marin", "sel"],
            ["lubrifiant", "lubrifi"], ["graphite", "PTFE"],
            ["humidité"], ["bois"], ["gonfl"],
            ["effraction"], ["assurance"], ["indemnis"],
            ["majoration"], ["jour férié", "jours fériés"], ["devis"],
            ["porte claquée"], ["justificatif"], ["mandat"],
            ["référent"], ["gestionnaire", "syndic"],
            ["serrurier"], ["serrure"], ["urgence"], ["rendez-vous"],
            ["assistance"], ["délai"],
        ],
    },
    "serrurier-dimanche-ferie-cotes-d-armor-22.html": {
        "requete": "serrurier dimanche jour férié Côtes-d'Armor",
        "termes": [
            ["Côtes-d'Armor"], ["Saint-Brieuc"], ["Lannion"],
            ["Dinan"], ["Guingamp"], ["Lamballe"],
            ["Trégor"], ["Perros-Guirec"], ["granit rose", "granit"],
            ["dimanche"], ["jour férié", "jours fériés"],
            ["majoration"], ["19 h", "19h"], ["nuit"],
            ["artisan"], ["intermédiaire"], ["plateforme", "plateformes"],
            ["revend", "revendent", "revente"], ["annonces payantes", "annonce"],
            ["SIRET"], ["annuaire des entreprises", "annuaire"],
            ["affichage des prix", "affichage"], ["obligation"],
            ["devis"], ["déplacement"], ["estimation"],
            ["refuser"], ["signé", "signer"], ["facture"],
            ["lettre recommandée", "recommandée"], ["SignalConso"],
            ["DGCCRF"], ["percé", "perce", "perçage"],
            ["cylindre"], ["serrurier"], ["serrure"],
            ["organigramme"], ["syndic", "bailleur"], ["astreinte"],
            ["assurance"], ["assistance"], ["double", "doubles"],
            ["entretien"], ["urgence"], ["porte claquée"],
            ["arrière-pays", "densité", "peu dense"],
        ],
    },
